...
<sub>And of course the more obscure, but cool ones like Racket, Haskell, Prolog (Thanks CSCC24), and ... MIPS assembly (never again - CSCB58)</sub>
...
<sub>And some experience with state management tools like Redux/NgRx and styling libraries such as Tailwind</sub>
...
<sub>I've mainly used Docker/Docker Compose to deploy applications to VMs on GCE or Azure Container apps using Github Actions</sub>

---- 
Feel free to send an [email](mailto:wongnathan1106@gmail.com) or a message on [LinkedIn](https://www.linkedin.com/in/nathanwong1106/) if you want to connect with me!
